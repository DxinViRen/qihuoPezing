...
- (void)configDataSource{
    ...
    celectModel.extra = [@{@"title":@"我的收藏",@"img":@"mycelect"} mutableCopy];
    ...
    aboutModel.extra = [@{@"title":@"关于我们",@"img":@"aboutus"} mutableCopy];
...
- (IGListSectionController *)listAdapter:(IGListAdapter *)listAdapter sectionControllerForObject:(id)object{
    ...
    secCt.cellDidClickBlock = ^(id<MainCellModelProtocol>  _Nonnull model, NSInteger index) {
        if([model.cellName isEqualToString:NSStringFromClass([LoginCell class])]){
            //退出登录
            [[NSUserDefaults standardUserDefaults]removeObjectForKey:@"13146725375"];
            //弹出登录界面
